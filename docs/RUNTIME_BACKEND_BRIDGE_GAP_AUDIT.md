...
| --- | --- | --- |
| MCP tool surface | 92 tools, exact `tools/list` membership enforced | `scripts/truth-gates.mjs` `server.stdio_handshake`; `scripts/v07-stdio-roundtrip-smoke-test.mjs` |
