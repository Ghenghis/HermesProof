...
- **Run id**: `truth_2026-05-03T03-35-59-939Z`
- **Timestamp (UTC)**: 2026-05-03T03:35:59.939Z
- **Duration**: 1.72s
...
| `tests.unit` | required | ✅ pass | 1053 ms | pass=29, fail=0, exit=0 |
| `server.stdio_handshake` | required | ✅ pass | 220 ms | 20 tools |
...
| `e2e.multi_agent_flow` | required | ✅ pass | 339 ms | 14/14 checks; 15 ledger, 11 events |
