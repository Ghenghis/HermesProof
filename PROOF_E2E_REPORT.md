...
- **Run id**: `truth_2026-05-03T15-19-24-182Z`
- **Timestamp (UTC)**: 2026-05-03T15:19:24.182Z
- **Duration**: 5.49s
...
| --- | --- | --- | --- | --- |
| `source.integrity_manifest` | required | ✅ pass | 13 ms | 44 files hashed |
| `deps.parity` | required | ✅ pass | 2 ms | all 3 deps installed |
| `tests.unit` | required | ✅ pass | 1762 ms | pass=99, fail=0, exit=0 |
| `server.stdio_handshake` | required | ✅ pass | 226 ms | 34 tools |
...
| `sbom.cyclonedx_generated` | required | ✅ pass | 36 ms | 92 components @ /home/runner/work/HermesProof/HermesProof/PROOF/sbom.json |
| `licenses.scan` | required | ✅ pass | 2563 ms | 93 packages scanned; unknown=0, review=1 |
| `dependency.fresh` | warn | ✅ pass | 206 ms | 3/3 direct deps within 12mo |
