...
- **Run id**: `truth_2026-05-09T07-42-45-706Z`
- **Timestamp (UTC)**: 2026-05-09T07:42:45.706Z
- **Duration**: 39.01s
...
| --- | --- | --- | --- | --- |
| `source.integrity_manifest` | required | ✅ pass | 14 ms | 73 files hashed |
| `deps.parity` | required | ✅ pass | 2 ms | all 3 deps installed |
| `tests.unit` | required | ✅ pass | 31470 ms | pass=289, fail=0, exit=0 |
| `server.stdio_handshake` | required | ✅ pass | 189 ms | 42 tools |
...
| `queue.doctor_passes` | required | ✅ pass | 148 ms | queue doctor ok |
| `wizard.dry_run_passes` | required | ✅ pass | 56 ms | wizard dry-run ok |
| `e2e.multi_agent_flow` | required | ✅ pass | 297 ms | 14/14 checks; 15 ledger, 11 events |
...
| `secret.scan` | required | ✅ pass | 34 ms | fallback: 0 finding(s) |
...
| `licenses.scan` | required | ✅ pass | 758 ms | 93 packages scanned; unknown=0, review=1 |
| `dependency.fresh` | warn | ✅ pass | 139 ms | 3/3 direct deps within 12mo |
| `security.workflow_actions_sha_pinned` | required | ✅ pass | 4 ms | 4 workflow(s), 17 uses-ref(s), all SHA-pinned |
| `accessibility.wcag_aa_pass` | required | ✅ pass | 1270 ms | 0 critical/serious violations across 22 passing rule(s) (1 non-blocking warning(s)) |
| `perf.budgets_pass` | required | ✅ pass | 4466 ms | hermes_doctor_cold_start=0.4ms<300ms? Y; lock_acquire=6.4ms<50ms? Y; heartbeat=2.5ms<20ms? Y |
