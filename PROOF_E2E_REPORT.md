...
- **Run id**: `truth_2026-05-09T15-04-21-441Z`
- **Timestamp (UTC)**: 2026-05-09T15:04:21.441Z
- **Duration**: 39.72s
...
| --- | --- | --- | --- | --- |
| `source.integrity_manifest` | required | ✅ pass | 21 ms | 74 files hashed |
| `deps.parity` | required | ✅ pass | 2 ms | all 3 deps installed |
| `tests.unit` | required | ✅ pass | 31559 ms | pass=297, fail=0, exit=0 |
...
| `tasks.directory_present` | required | ✅ pass | 8 ms | pending/claimed/blocked/done present |
| `trigger.doctor_passes` | required | ✅ pass | 75 ms | trigger doctor ok |
| `queue.doctor_passes` | required | ✅ pass | 165 ms | queue doctor ok |
| `wizard.dry_run_passes` | required | ✅ pass | 63 ms | wizard dry-run ok |
| `e2e.multi_agent_flow` | required | ✅ pass | 372 ms | 14/14 checks; 15 ledger, 11 events |
...
| `sbom.cyclonedx_generated` | required | ✅ pass | 54 ms | 131 components @ /home/runner/work/HermesProof/HermesProof/PROOF/sbom.json |
| `licenses.scan` | required | ✅ pass | 961 ms | 93 packages scanned; unknown=0, review=1 |
...
| `accessibility.wcag_aa_pass` | required | ✅ pass | 1626 ms | 0 critical/serious violations across 22 passing rule(s) (1 non-blocking warning(s)) |
| `perf.budgets_pass` | required | ✅ pass | 4256 ms | hermes_doctor_cold_start=0.6ms<300ms? Y; lock_acquire=7.3ms<50ms? Y; heartbeat=2.9ms<20ms? Y |
