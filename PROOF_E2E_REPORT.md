...
- **Run id**: `truth_2026-05-03T18-55-59-161Z`
- **Timestamp (UTC)**: 2026-05-03T18:55:59.161Z
- **Duration**: 9.16s
...
| --- | --- | --- | --- | --- |
| `source.integrity_manifest` | required | ✅ pass | 15 ms | 68 files hashed |
| `deps.parity` | required | ✅ pass | 1 ms | all 3 deps installed |
| `tests.unit` | required | ✅ pass | 2298 ms | pass=140, fail=0, exit=0 |
| `server.stdio_handshake` | required | ✅ pass | 213 ms | 42 tools |
...
| `e2e.multi_agent_flow` | required | ✅ pass | 330 ms | 14/14 checks; 15 ledger, 11 events |
...
| `sbom.cyclonedx_generated` | required | ✅ pass | 40 ms | 131 components @ /home/runner/work/HermesProof/HermesProof/PROOF/sbom.json |
| `licenses.scan` | required | ✅ pass | 890 ms | 93 packages scanned; unknown=0, review=1 |
| `dependency.fresh` | warn | ✅ pass | 309 ms | 3/3 direct deps within 12mo |
| `security.workflow_actions_sha_pinned` | required | ✅ pass | 3 ms | 4 workflow(s), 17 uses-ref(s), all SHA-pinned |
| `accessibility.wcag_aa_pass` | required | ✅ pass | 1499 ms | 0 critical/serious violations across 22 passing rule(s) (1 non-blocking warning(s)) |
| `perf.budgets_pass` | required | ✅ pass | 3198 ms | hermes_doctor_cold_start=0.5ms<300ms? Y; lock_acquire=6.1ms<50ms? Y; heartbeat=2.1ms<20ms? Y |
