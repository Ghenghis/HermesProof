...
- **Run id**: `truth_2026-05-03T18-33-00-062Z`
- **Timestamp (UTC)**: 2026-05-03T18:33:00.062Z
- **Duration**: 10.67s
...
| --- | --- | --- | --- | --- |
| `source.integrity_manifest` | required | ✅ pass | 19 ms | 67 files hashed |
| `deps.parity` | required | ✅ pass | 1 ms | all 3 deps installed |
| `tests.unit` | required | ✅ pass | 2505 ms | pass=140, fail=0, exit=0 |
| `server.stdio_handshake` | required | ✅ pass | 239 ms | 42 tools |
...
| `evidence.hash_chain_valid` | required | ✅ pass | 5 ms | positive=true, negative_detected_at_idx_1=true |
...
| `sbom.cyclonedx_generated` | required | ✅ pass | 46 ms | 131 components @ /home/runner/work/HermesProof/HermesProof/PROOF/sbom.json |
| `licenses.scan` | required | ✅ pass | 986 ms | 93 packages scanned; unknown=0, review=1 |
| `dependency.fresh` | warn | ✅ pass | 176 ms | 3/3 direct deps within 12mo |
| `security.workflow_actions_sha_pinned` | required | ✅ pass | 5 ms | 4 workflow(s), 17 uses-ref(s), all SHA-pinned |
| `accessibility.wcag_aa_pass` | required | ✅ pass | 1631 ms | 0 critical/serious violations across 22 passing rule(s) (1 non-blocking warning(s)) |
| `perf.budgets_pass` | required | ✅ pass | 4267 ms | hermes_doctor_cold_start=0.6ms<300ms? Y; lock_acquire=7.6ms<50ms? Y; heartbeat=2.7ms<20ms? Y |
