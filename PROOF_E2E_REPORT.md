...
- **Run id**: `truth_2026-05-03T13-29-36-983Z`
- **Timestamp (UTC)**: 2026-05-03T13:29:36.983Z
- **Duration**: 4.91s
...
| `tests.unit` | required | ✅ pass | 1639 ms | pass=52, fail=0, exit=0 |
| `server.stdio_handshake` | required | ✅ pass | 216 ms | 24 tools |
...
| `licenses.scan` | required | ✅ pass | 2379 ms | 93 packages scanned; unknown=0, review=1 |
