...
- **Run id**: `truth_2026-05-02T20-41-11-495Z`
- **Timestamp (UTC)**: 2026-05-02T20:41:11.495Z
- **Duration**: 0.60s
...
| `tests.unit` | required | ✅ pass | 164 ms | pass=12, fail=0, exit=0 |
| `server.stdio_handshake` | required | ✅ pass | 187 ms | 15 tools |
| `doctor.hermes3d` | skipped | ✅ pass | 0 ms | skipped |
| `e2e.multi_agent_flow` | required | ✅ pass | 240 ms | 14/14 checks; 3 ledger, 11 events |
