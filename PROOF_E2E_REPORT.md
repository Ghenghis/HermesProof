...
- **Run id**: `truth_2026-05-03T18-07-57-164Z`
- **Timestamp (UTC)**: 2026-05-03T18:07:57.164Z
- **Duration**: 8.61s
- **Hermes3D workspace**: `/home/runner/work/HermesProof/HermesProof`
- **Node**: v20.20.2 on linux
- **Result**: ✅ ALL REQUIRED GATES PASS

Pass / Fail / Warn / Skip: **25 / 0 / 2 / 4**

## Gate results

| Gate | Level | Result | Duration | Detail |
| --- | --- | --- | --- | --- |
| `source.integrity_manifest` | required | ✅ pass | 21 ms | 59 files hashed |
| `deps.parity` | required | ✅ pass | 2 ms | all 3 deps installed |
| `tests.unit` | required | ✅ pass | 2526 ms | pass=140, fail=0, exit=0 |
...
| `wizard.dry_run_passes` | required | ✅ pass | 64 ms | wizard dry-run ok |
| `e2e.multi_agent_flow` | required | ✅ pass | 376 ms | 14/14 checks; 15 ledger, 11 events |
...
| `licenses.scan` | required | ✅ pass | 2930 ms | 93 packages scanned; unknown=0, review=1 |
| `dependency.fresh` | warn | ✅ pass | 388 ms | 3/3 direct deps within 12mo |
| `security.workflow_actions_sha_pinned` | required | ✅ pass | 3 ms | 4 workflow(s), 17 uses-ref(s), all SHA-pinned |
| `accessibility.wcag_aa_pass` | required | ✅ pass | 1658 ms | 0 critical/serious violations across 22 passing rule(s) (1 non-blocking warning(s)) |
