...
- **Run id**: `truth_2026-05-03T20-13-28-845Z`
- **Timestamp (UTC)**: 2026-05-03T20:13:28.845Z
- **Duration**: 9.34s
...
| `tests.unit` | required | ✅ pass | 2373 ms | pass=141, fail=0, exit=0 |
| `server.stdio_handshake` | required | ✅ pass | 228 ms | 42 tools |
...
| `trigger.doctor_passes` | required | ✅ pass | 69 ms | trigger doctor ok |
| `queue.doctor_passes` | required | ✅ pass | 150 ms | queue doctor ok |
| `wizard.dry_run_passes` | required | ✅ pass | 61 ms | wizard dry-run ok |
| `e2e.multi_agent_flow` | required | ✅ pass | 344 ms | 14/14 checks; 15 ledger, 11 events |
...
| `secret.scan` | required | ✅ pass | 45 ms | fallback: 0 finding(s) |
...
| `dependency.fresh` | warn | ✅ pass | 404 ms | 3/3 direct deps within 12mo |
| `security.workflow_actions_sha_pinned` | required | ✅ pass | 6 ms | 4 workflow(s), 17 uses-ref(s), all SHA-pinned |
| `accessibility.wcag_aa_pass` | required | ✅ pass | 1465 ms | 0 critical/serious violations across 22 passing rule(s) (1 non-blocking warning(s)) |
| `perf.budgets_pass` | required | ✅ pass | 3106 ms | hermes_doctor_cold_start=0.4ms<300ms? Y; lock_acquire=5.2ms<50ms? Y; heartbeat=2.3ms<20ms? Y |
