...
- **Run id**: `truth_2026-05-03T14-32-49-120Z`
- **Timestamp (UTC)**: 2026-05-03T14:32:49.120Z
- **Duration**: 5.05s
...
| --- | --- | --- | --- | --- |
| `source.integrity_manifest` | required | ✅ pass | 10 ms | 36 files hashed |
| `deps.parity` | required | ✅ pass | 2 ms | all 3 deps installed |
| `tests.unit` | required | ✅ pass | 1566 ms | pass=86, fail=0, exit=0 |
...
| `queue.doctor_passes` | required | ✅ pass | 158 ms | queue doctor ok |
| `wizard.dry_run_passes` | required | ✅ pass | 57 ms | wizard dry-run ok |
...
| `sbom.cyclonedx_generated` | required | ✅ pass | 30 ms | 92 components @ /home/runner/work/HermesProof/HermesProof/PROOF/sbom.json |
| `licenses.scan` | required | ✅ pass | 2313 ms | 93 packages scanned; unknown=0, review=1 |
| `dependency.fresh` | warn | ✅ pass | 319 ms | 3/3 direct deps within 12mo |
