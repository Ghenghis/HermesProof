...
- **Run id**: `truth_2026-05-03T14-09-58-894Z`
- **Timestamp (UTC)**: 2026-05-03T14:09:58.894Z
- **Duration**: 5.05s
...
| `tests.unit` | required | ✅ pass | 1668 ms | pass=52, fail=0, exit=0 |
| `server.stdio_handshake` | required | ✅ pass | 221 ms | 24 tools |
...
| `e2e.multi_agent_flow` | required | ✅ pass | 358 ms | 14/14 checks; 15 ledger, 11 events |
...
| `licenses.scan` | required | ✅ pass | 2454 ms | 93 packages scanned; unknown=0, review=1 |
