...
- **Run id**: `truth_2026-08-12T22-12-31-035Z`
- **Timestamp (UTC)**: 2026-08-12T22:12:31.035Z
- **Duration**: 49.13s
...
| `tests.unit` | required | ✅ pass | 31299 ms | pass=510, fail=0, exit=0 |
...
| `trigger.doctor_passes` | required | ✅ pass | 248 ms | trigger doctor ok |
| `queue.doctor_passes` | required | ✅ pass | 408 ms | queue doctor ok |
| `wizard.dry_run_passes` | required | ✅ pass | 518 ms | wizard dry-run ok |
| `e2e.multi_agent_flow` | required | ✅ pass | 768 ms | 14/14 checks; 15 ledger, 11 events |
| `workspace.integrity` | required | ✅ pass | 126 ms | probes=0, install_mods=0, expected_mods=0, unexpected_mods=0, unexpected_untracked=0 |
| `clients.config_presence` | required | ✅ pass | 2 ms | all 4 present |
| `clients.claude_code_live` | required | ✅ pass | 5031 ms | 2/2 connected |
...
| `lmstudio.health` | warn | ⚠️ warn | 5006 ms | LM Studio offline: ECONNREFUSED |
...
| `gitlab.auth_probe` | warn | ✅ pass | 281 ms | GitLab authenticated via gitlab_env_file:GITLAB_TOKEN |
| `secret.scan` | required | ✅ pass | 141 ms | fallback: 0 finding(s) |
| `secrets.rotation_evidence_present` | warn | ✅ pass | 1 ms | env mtime 2026-08-08T19:54:02.512Z (age 4.1d <= max 90d) |
| `sbom.cyclonedx_generated` | required | ✅ pass | 38 ms | 96 components @ C:/Users/Admin/Documents/Codex/2026-08-08/g-github-hermes3d-mcp-lock-orchestrator-2/work/hermesproof-release/PROOF/sbom.json |
| `licenses.scan` | required | ✅ pass | 1487 ms | 99 packages scanned; unknown=0, review=1 |
| `dependency.fresh` | warn | ✅ pass | 1353 ms | 7/7 direct deps within 12mo |
| `security.workflow_actions_sha_pinned` | required | ✅ pass | 1 ms | 0 workflow(s), 0 uses-ref(s), all SHA-pinned |
| `accessibility.wcag_aa_pass` | required | ✅ pass | 1057 ms | 0 critical/serious violations across 21 passing rule(s) (1 non-blocking warning(s)) |
