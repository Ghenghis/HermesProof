...
- **Run id**: `truth_2026-05-03T20-21-10-142Z`
- **Timestamp (UTC)**: 2026-05-03T20:21:10.142Z
- **Duration**: 10.34s
...
| `tests.unit` | required | ✅ pass | 2489 ms | pass=141, fail=0, exit=0 |
| `server.stdio_handshake` | required | ✅ pass | 227 ms | 42 tools |
...
| `queue.doctor_passes` | required | ✅ pass | 174 ms | queue doctor ok |
| `wizard.dry_run_passes` | required | ✅ pass | 66 ms | wizard dry-run ok |
| `e2e.multi_agent_flow` | required | ✅ pass | 356 ms | 14/14 checks; 15 ledger, 11 events |
...
| `secret.scan` | required | ✅ pass | 49 ms | fallback: 0 finding(s) |
...
| `sbom.cyclonedx_generated` | required | ✅ pass | 41 ms | 131 components @ /home/runner/work/HermesProof/HermesProof/PROOF/sbom.json |
| `licenses.scan` | required | ✅ pass | 956 ms | 93 packages scanned; unknown=0, review=1 |
| `dependency.fresh` | warn | ✅ pass | 286 ms | 3/3 direct deps within 12mo |
| `security.workflow_actions_sha_pinned` | required | ✅ pass | 2 ms | 4 workflow(s), 17 uses-ref(s), all SHA-pinned |
| `accessibility.wcag_aa_pass` | required | ✅ pass | 1529 ms | 0 critical/serious violations across 22 passing rule(s) (1 non-blocking warning(s)) |
| `perf.budgets_pass` | required | ✅ pass | 3993 ms | hermes_doctor_cold_start=0.5ms<300ms? Y; lock_acquire=6.7ms<50ms? Y; heartbeat=2.5ms<20ms? Y |
