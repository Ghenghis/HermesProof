...
- **Run id**: `truth_2026-05-03T01-43-16-538Z`
- **Timestamp (UTC)**: 2026-05-03T01:43:16.538Z
- **Duration**: 1.09s
...
| --- | --- | --- | --- | --- |
| `source.integrity_manifest` | required | ✅ pass | 8 ms | 18 files hashed |
| `deps.parity` | required | ✅ pass | 2 ms | all 2 deps installed |
| `tests.unit` | required | ✅ pass | 405 ms | pass=26, fail=0, exit=0 |
| `server.stdio_handshake` | required | ✅ pass | 231 ms | 20 tools |
